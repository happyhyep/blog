...
export default function Introduce() {
    ...
    return(
        <>
            ...
            <div style={{display:"flex",  justifyContent: 'space-between', margin: 'auto', width:'355px', marginTop: '10px', marginBottom: '10px'}} >
            ...
            <div style={{display:"flex",  justifyContent: 'space-between', margin: 'auto', width:'194px', marginTop: '10px', marginBottom: '10px'}} >
                <img src="https://img.shields.io/badge/Node.js-339933?style=flat&logo=Node.js&logoColor=white"/>
                <img src="https://img.shields.io/badge/Python-3776AB?style=flat&logo=Python&logoColor=white"/>
                <img src="https://img.shields.io/badge/C++-00599C?style=flat&logo=cplusplus&logoColor=white"/>
            </div>
            <div style={{display:"flex",  justifyContent: 'space-between', margin: 'auto', width:'168.5px', marginTop: '10px', marginBottom: '10px'}} >
                <img src="https://img.shields.io/badge/PostgreSQL-4169E1?style=flat&logo=PostgreSQL&logoColor=black"/>
                <img src="https://img.shields.io/badge/Firebase-FFCA28?style=flat&logo=firebase&logoColor=black" />
</div>
            <div style={{display:"flex",  justifyContent: 'space-between', margin: 'auto', width:'267px', marginTop: '10px', marginBottom: '10px'}} >
            ...
            <div style={{display:"flex",  justifyContent: 'space-between', margin: 'auto', width:'307.5px', marginTop: '10px', marginBottom: '10px'}} >
